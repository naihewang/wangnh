...
package JDK.juc.AQS.ReentranLock;
...
public class ReentrantLock implements Lock, java.io.Serializable {
     ...
     */
    abstract static class Sync extends JDK.juc.AQS.Condition.AbstractQueuedSynchronizer {
    ...
    public boolean hasWaiters(Condition condition) {
        ...
        if (!(condition instanceof JDK.juc.AQS.Condition.AbstractQueuedSynchronizer.ConditionObject))
            throw new IllegalArgumentException("not owner");
        return sync.hasWaiters((JDK.juc.AQS.Condition.AbstractQueuedSynchronizer.ConditionObject)condition);
    }
    ...
    public int getWaitQueueLength(Condition condition) {
        ...
        if (!(condition instanceof JDK.juc.AQS.Condition.AbstractQueuedSynchronizer.ConditionObject))
            throw new IllegalArgumentException("not owner");
        return sync.getWaitQueueLength((JDK.juc.AQS.Condition.AbstractQueuedSynchronizer.ConditionObject)condition);
    }
